 ...
 *	Exercise Description: Fuel sensor on A3 - A0. C5 - C0 display the corresponding fuel level. C6 is a low fuel light that lights when the fuel is level 4 or less.
 *
